...
if (t.either.isRight(vr1)) {
  const v1 = t.either.fromRight(vr1)
  ;(v1: number)
  // $ExpectError
  ;(v1: string)
}
...
if (t.either.isRight(vr2)) {
  const v2 = t.either.fromRight(vr2)
  ;(v2: A)
  // $ExpectError
  ;(v2: string)
}
...
if (t.either.isRight(vr3)) {
  const v3 = t.either.fromRight(vr3)
  ;(v3: 'a')
  // $ExpectError
  ;(v3: 'b')
}
...
if (t.either.isRight(vr4)) {
  const v4 = t.either.fromRight(vr4)
  ;(v4: Array<number>)
  // $ExpectError
  ;(v4: Array<string>)
}
...
if (t.either.isRight(vr5)) {
  const v5 = t.either.fromRight(vr5)
  ;(v5: string | number)
  // $ExpectError
  ;(v5: string)
}
...
if (t.either.isRight(vr6)) {
  const v6 = t.either.fromRight(vr6)
  ;(v6: [string, number])
  // $ExpectError
  ;(v6: [number, number])
}
...
if (t.either.isRight(vr7)) {
  const v7 = t.either.fromRight(vr7)
...
if (t.either.isRight(vr8)) {
  const v8 = t.either.fromRight(vr8)
  ;(v8: ?number)
  // $ExpectError
  ;(v8: ?string)
}
...
if (t.either.isRight(vr10)) {
  const v10 = t.either.fromRight(vr10)
  ;(v10: number)
  // $ExpectError
  ;(v10: string)
}
...
if (t.either.isRight(vr11)) {
  const v11 = t.either.fromRight(vr11)
  ;(v11: T11T)
  // $ExpectError
  ;(v11: string)
}
...
if (t.either.isRight(vr12)) {
  const v12 = t.either.fromRight(vr12)
  ;(v12: 'a' | 'b')
  ;(v12: string)
  // $ExpectError
  ;(v12: number)
...
if (t.either.isRight(vr13)) {
  const v13 = t.either.fromRight(vr13)
  ;(v13: {| a: number |})
  // $ExpectError
  ;(v13: number)
}
...
if (t.either.isRight(vr14)) {
  const v14 = t.either.fromRight(vr14)
  ;(v14: $Shape<{ a: number }>)
  // $ExpectError
...
if (t.either.isRight(vr15)) {
  const v15 = t.either.fromRight(vr15)
  ;(v15: T15T)
  // $ExpectError
  ;(v15.b.d.e: string)
}
...
if (t.either.isRight(vr16)) {
  const v16 = t.either.fromRight(vr16)
  ;(v16: Class<A>)
  // $ExpectError
  ;(v16: string)
}
